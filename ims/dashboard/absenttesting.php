                ...
                <div class="row" style="margin-left:53px">
                    ...
                    <div class="col s12 m12 l12">
                        <div class="card">
							...
							$sqll = mysqli_query($con,"SELECT * FROM attendance_record WHERE subject LIKE '%$subject[0]%'");
							$rowCount1 = mysqli_num_rows ($sqll);
							
							$AbsentCount= $rowCount-$rowCount1;

							echo "<p style='font-size:30 px; text-align: left'>" . "Total Students : " . $rowCount ;
							echo "<p style='font-size:30 px; text-align: left'>" . "Total Students Present : " . $rowCount1 ;
							echo "<p style='font-size:30 px; text-align: left'>" . "Total Students Absent : " .$AbsentCount  ;
							?>
							...
							$sql = mysqli_query($con,"SELECT s_id FROM student WHERE s_subject LIKE '%$subject[0]%'");
							$rowCount = mysqli_num_rows ($sql);
							
							$sqll = mysqli_query($con,"SELECT id FROM attendance_record WHERE subject LIKE '%$subject[0]%'");
							$rowCount1 = mysqli_num_rows ($sqll);
...
$clean1 = array_diff($datas, $datass); 

foreach($clean1 as $output){
	echo $output." ";
}
} 
// Close connection
