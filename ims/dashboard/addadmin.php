...
$sql="INSERT INTO admin(Username,Password) VALUES(:empna,:password)";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Students Attendance System | Add Admin </title>
...
error:function (){}
    ...
    <?php include('includes/addadminheader.php');?>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <form id="example-form" method="post" name="addemp">
                                    <div>
                                        <h3 style="margin-left:18px;">Admin Info</h3>
                                        <section>
