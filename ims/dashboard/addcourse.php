...
$sql="INSERT INTO course(course) VALUES(:name)";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Students Attendance System | Add Course </title>
...
error:function (){}
    ...
    <?php include('includes/addcourseheader.php');
		include('includes/schedulersidebar.php');?>
    <main class="mn-inner">
