...
$sql="INSERT INTO scheduler(Username,Password) VALUES(:empna,:password)";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Students Attendance System | Add Scheduler </title>
...
error:function (){}
    ...
    <?php include('includes/addschedulerheader.php');?>
            
    <?php include('includes/itsidebar.php');?>
    <main class="mn-inner">
                <div class="row" style="margin-left:53px">
                    <div class="col s12">
                        <div class="page-title">Add Scheduler</div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <form id="example-form" method="post" name="addemp">
                                    <div>
                                        <h3 style="margin-left:18px;">Scheduler Info</h3>
                                        <section>
