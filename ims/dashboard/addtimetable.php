...
$sql="INSERT INTO timetable(sub_course,sub_name,sub_lecturer,sub_class,starttime,endtime,day) VALUES('$name','$sub','$lecturer','$classroom','$starttime','$endtime','$day')";
...
.succWrap{
    ...
    <main class="mn-inner">
     ...
     <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
																	...
																	<div class="input-field col s12">
																	<label for="starttime" style = "font-size">Start Time</label></br></br>
																	<input id="starttime" name="starttime" type="time" required>   
																	</div>
																	
																		
																	<div class="input-field col s12">
																	<label for="endtime" style = "font-size">End Time</label></br></br>
