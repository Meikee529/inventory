...
if(isset($_POST['add']))
{
	...
	foreach($myArray as $serial)
	{
		$sql="INSERT INTO timetable(sub_course,sub_name,sub_lecturer,sub_class) VALUES('$name','$sub','$lecturer','$classroom')";
		/*$sql="INSERT INTO stockin(sin_do,sin_partnum,sin_proname,sin_category,sin_serialnum,sin_datein,sin_status,sin_user,sin_prodes,sin_cusname,sin_cpic) VALUES(:do,:panumb,:projnamee,:catt,:serial,:da,:status,:name,:prodes,:cn,:cin)";*/
