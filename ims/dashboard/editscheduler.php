...
$sql="UPDATE scheduler SET UserName= '$name',Password= '$password' WHERE scheduler_id= '$pid'";
$query = $dbh->prepare($sql);
$query->execute();

$lastInsertId = $dbh->lastInsertId();
$msg="Scheduler Info Updated Successfully";
}
}
?>
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Students Attendance System | Edit Scheduler</title>
...
.succWrap{
    ...
    <?php include('includes/editschedulerheader.php');?>
            
       <?php include('includes/itsidebar.php');?>
    <main class="mn-inner">
                <div class="row" style="margin-left:53px">
                    <div class="col s12">
                        <div class="page-title">Edit Scheduler</div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <form id="example-form" method="post" name="updatemp">
                                    <div>
                                        <h3 style="margin-left:18px;">Edit Scheduler Details</h3>
                                                ...
                                                <div class="row">
                                                    <div class="col m6">
                                                        <div class="row">
															<?php 
															$pid=intval($_GET['schedulerid']);
															$sql = "SELECT * from scheduler where scheduler_id=:pid";
															$query = $dbh -> prepare($sql);
															...
															<a href="managescheduler.php" class="waves-effect waves-light btn indigo m-b-xs" >Back</a>
															</div>
