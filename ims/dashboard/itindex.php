...
$sql ="SELECT * FROM it WHERE UserName=:uname and Password=:password";
...
foreach ($results as $result) {
		...
		$_SESSION['aid']=$result->it_id;
		
	}
echo "<script type='text/javascript'> document.location = 'dashboard/itdashboard.php'; </script>";
} else{
            ...
            <main class="mn-inner">
                <div class="row">
					...
					<center><img src="logo.png" class="center" alt="login" width="600" height="150"></center>
						<h4 align="center" style="font-weight:500" ><b>Students Attendance System | IT Login</b></h4>
