                                ...
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="400"><center>Subject</center></th>										
											<!--th width="10%">Classroom</th>
											<th width="10%">Start Time</th>
											<th width="10%">End Time</th>
                                            <th width="10%">Day</th-->
											<th width="80"><center>Attendance</center></th>
											<th width="80"><center>Chart</center></th>
											<th width="80"><center>Absent Info (Warning)</center></th>
											<th width="80"><center>Student Info</center></th>
                                        </tr>
                                    </thead>
...
{         
      ?>  
                                        ...
                                        <tr>
											...
											<td><center><a href="absentinfo.php?sub_id=<?php echo htmlentities($result->sub_id);?>"><i class="material-icons" title="Edit">new_releases</i></a></center></td>
