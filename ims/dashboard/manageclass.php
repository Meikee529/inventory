...
{
$id=$_GET['mpid'];
$sql = "delete from classroom WHERE c_id=:id";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Students Attendance System | Manage Classroom </title>
...
.succWrap{
    ...
    <body style="background-color:#d3d9de;">
        <?php include('includes/manageclassheader.php');?>
            
        <?php include('includes/schedulersidebar.php');?>
            <main class="mn-inner">
                <div class="row" style="margin-left:53px">
                    <div class="col s12">
                        <div class="page-title">Total Classroom</div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            <th width="250">Classroom number</th>
											<th width="50">Action</th>
                                        </tr>
                                    </thead>
                                 
                                    <tbody>
<?php $sql = "SELECT * from classroom ";
$query = $dbh -> prepare($sql);
$query->execute();
...
{         
      ?>  
                                        ...
                                        <tr>
											...
											<td><!--a href="editclassroom.php?lecturerid=<!--?php echo htmlentities($result->l_id);?>"><i class="material-icons" title="Edit">mode_edit</i></a-->
