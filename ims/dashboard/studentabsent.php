        ...
        <?php include('includes/lecturersidebar.php');?>
            <main class="mn-inner">
                <div class="row" style="margin-left:53px">
                    <div class="col s12">
                        <div class="page-title">Absent Info</div>
                    </div>
                                ...
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
											...
											<th width="100"><center>Absent students</center></th>
...
{         
      ?>  
                                        ...
                                        <tr>
											...
											<td><center><a href="absentinfo.php?sub_id=<?php echo htmlentities($result->sub_id);?>"><i class="material-icons" title="Edit">info</i></a></center></td>
