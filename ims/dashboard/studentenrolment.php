...
error:function (){}
	...
	<body style="background-color:#d3d9de;">
        <?php include('includes/studentenrolmentheader.php');?>
...
{         
      ?>  
                                        ...
                                        <tr>
											...
											<td><a href="addstudentsubject.php?studentid=<?php echo htmlentities($result->s_id);?>"><i class="material-icons" title="Edit">mode_edit</i></a>
