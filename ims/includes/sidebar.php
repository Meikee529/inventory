...
<?php }} ?>
				...
				<li class="no-padding"><a class="waves-effect waves-grey" href="emp-changepassword.php"><i class="material-icons" style="font-size:21px;"><b>🔐</b></i><b>Change Password</b></a></li>
					...
					<li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons" style="font-size:21px;"><b>😄</b></i><i class="nav-drop-icon material-icons">keyboard_arrow_right</i><b>Supplier</b></a>
					...
					<li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons" style="font-size:21px;"><b>😀</b></i><i class="nav-drop-icon material-icons">keyboard_arrow_right</i><b>Customer</b></a>
                        <div class="collapsible-body">
                            <ul>
